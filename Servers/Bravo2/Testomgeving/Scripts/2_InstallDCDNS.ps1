...
# Start-Sleep zal 15 seconden wachten voor hij aan het eerste commando van dit script begint
...
$DSRMPassword = "Admin2019"
Set-ItemProperty "DefaultPassword" -Value "$DSRMPassword" 
