...
4. [Hyper-V](#Hyper-V)  
   4.1. [Aanmaken Virtuele Switches](#Switch)  
   4.2. [Aanmaken Virtuele Machine](#Machine)  
   4.3. [Configuratie Virtuele Machine](#CMachine)  
   4.4. [Installatie pfsense](#InstallatieP)
   4.5. [Wijzigen Hyper-V LAN Adapter Host ](#Adapter)
